...
class SmsDemo extends Common
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIAutgqdDFqZXM"; // AccessKeyId

        $accessKeySecret = "IDvYscTGFSD3SacMCJBn5QvDopRxIJ"; // AccessKeySecret
     ...
     * $r工程报价信息
     */
    public static function sendSms($m,$p,$t,$r) {
        ...
        $request->setSignName("久居整装装修网");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode($t);
     ...
     * @param $t
     */
    public static function sendSms2($m,$p,$t) {
